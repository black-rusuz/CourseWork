...
import ru.sfedu.photohaven.utils.JdbcUtil;
...
public class DataProviderJdbc extends AbstractDataProvider {
    ...
    public DataProviderJdbc() {
        ...
        try {
            write(JdbcUtil.createTable(new Accessory()));
            write(JdbcUtil.createTable(new Basket()));
            write(JdbcUtil.createTable(new Camera()));
            write(JdbcUtil.createTable(new Material()));
