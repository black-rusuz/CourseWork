...
import ru.sfedu.goslingdrive.utils.JdbcUtil;
...
public class DataProviderJdbc extends AbstractDataProvider {
    ...
    public DataProviderJdbc() {
        ...
        try {
            write(JdbcUtil.createTable(new BodyPart()));
            write(JdbcUtil.createTable(new ElectricPart()));
            write(JdbcUtil.createTable(new Order()));
            write(JdbcUtil.createTable(new RunningPart()));
            write(JdbcUtil.createTable(new User()));
